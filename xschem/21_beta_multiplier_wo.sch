...
C {sky130_fd_pr/res_generic_m2.sym} 640 -760 1 0 {name=R1
W=0.4
L=16000
...
C {devices/lab_wire.sym} 980 -800 2 1 {name=l6 sig_type=std_logic lab=Vbiasp}
...
descr="View Raw file" 
tclcommand="textwindow $netlist_dir/21_beta_multiplier_wo.raw"}
