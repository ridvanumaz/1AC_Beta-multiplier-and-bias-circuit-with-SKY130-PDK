...
C {devices/vsource.sym} 350 -430 0 0 {name=VGS value=1.155
}
...
C {devices/lab_pin.sym} 470 -530 0 0 {name=l4 sig_type=std_logic lab=VDS}
...
C {devices/launcher.sym} 490 -590 0 0 {name=h2
descr="View Raw file" 
tclcommand="textwindow $netlist_dir/1_nmos_vgs.raw"}
C {devices/launcher.sym} 490 -650 0 0 {name=h1
descr="Annotate OP" 
